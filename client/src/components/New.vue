...
<template>
  ...
  <div class="card-media">
    ...
    <div class="card-media-object-container">
      <img class="card-media-object" :src="image" height="7vw" contain></img>
    </div>
    <!-- body container -->
    <div class="card-media-body">
      ...
      <div class="card-media-body-supporting-bottom card-media-body-supporting-bottom-reveal">
        ...
        <a href="this.url" class="card-media-body-supporting-bottom-text card-media-link u-float-right">VIEW TICKETS</a>
      </div>
    </div>
  </div>
